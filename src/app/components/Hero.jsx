        ...
        <section className="text-center">
            ...
            <div className="pt-10 text-gray-200 relative">
                <div className="relative inline-block w-1/3">
                    <input type="text" className="border border-gray-200 bg-gray-50 p-2 w-full px-4 text-gray-700 rounded-md focus:border-gray-300 outline-none" placeholder="Search for articles..."/>
